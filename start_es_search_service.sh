...
# Load env overrides and bridge from ES_SERVICE_* to ES_SEARCH_SERVICE_* so search service can reuse ES creds.
...
: "${ES_SEARCH_SERVICE_ES__REQUEST_TIMEOUT_SEC:=${ES_SERVICE_ES__REQUEST_TIMEOUT_SEC:-}}"
: "${ES_SEARCH_SERVICE_ES__READ_ALIAS:=${ES_SERVICE_ES__READ_ALIAS:-}}"
: "${ES_SEARCH_SERVICE_ES__DEFAULT_INDEX:=${ES_SERVICE_ES__DEFAULT_INDEX:-}}"
