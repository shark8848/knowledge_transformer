...
import es_index_service.api.routes as routes
import es_index_service.app as app_module
from es_index_service.app import create_app
from es_index_service.config import CelerySettings, ESSettings, ServiceSettings
...
def test_health_endpoint_works():
    ...
    assert data["service"] == "es-index-service"
    assert data["version"]
