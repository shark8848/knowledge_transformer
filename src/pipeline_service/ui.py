"""Gradio UI for uploading documents and triggering pipeline recommendations."""
...
PIPELINE_API_URL = os.getenv("PIPELINE_API_URL", "http://127.0.0.1:9100")
DEFAULT_PAGE_LIMIT = int(os.getenv("PIPELINE_SAMPLE_PAGES", "500"))
